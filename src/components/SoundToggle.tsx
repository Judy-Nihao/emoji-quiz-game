...
import { toggleSound, isSoundEnabled, playCursorSound } from "../utils/soundEffects";
...
export const SoundToggle = () => {
  ...
  return (
    <button
      ...
      className="gbc-button bg-white text-black p-2 min-w-[48px] min-h-[48px] hover:bg-gbc-light active:shadow-[inset_2px_2px_0_#8B9594] transition-all flex items-center justify-center"
    ...
    >
      {enabled ? (
        ...
        <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
          {/* Speaker body */}
          <rect x="2" y="7" width="4" height="6" fill="currentColor"/>
          {/* Speaker cone */}
          <path d="M6 7L6 13L11 16L11 4L6 7Z" fill="currentColor"/>
