...
export const SoundToggle = () => {
  ...
  return (
    <button
      ...
      className="hidden gbc-button bg-white text-black p-2 min-w-12 min-h-10 hover:bg-gbc-light active:shadow-[inset_2px_2px_0_#8B9594] transition-all md:flex md:items-center md:justify-center"
