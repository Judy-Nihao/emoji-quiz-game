  ...
  return (
    <div className="h-[40px] relative shrink-0 w-[120px]" data-name="Heading 1">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[40px] relative w-[120px]">
        <p className="absolute font-['Press_Start_2P:Regular',sans-serif] leading-[40px] left-[60px] not-italic text-[20px] text-center text-nowrap text-white top-0 translate-x-[-50%] whitespace-pre">
          GREAT!
        </p>
      </div>
    </div>
...
function Container1() {
  return (
    <div
      className="absolute content-stretch flex items-start left-[205.53px] size-[74.949px] top-[17.52px]"
      data-name="Container"
    >
      <p className="font-['Press_Start_2P:Regular',sans-serif] leading-[72px] not-italic relative shrink-0 text-[72px] text-neutral-950 text-nowrap whitespace-pre">
        ⭐
      </p>
    </div>
  );
...
function Text() {
  return (
    <div
      className="absolute h-[36px] left-[127.5px] top-[107.19px] w-[30px]"
      data-name="Text"
    >
...
function Text1() {
  return (
    <div
      className="absolute h-[36px] left-[187.5px] top-[35.2px] w-[30px]"
      data-name="Text"
    />
  );
}
...
function Text2() {
  return (
    <div
      className="absolute content-stretch flex h-[14px] items-start left-[122.5px] top-[5.5px] w-[145px]"
      data-name="Text"
    >
...
function Text3() {
  return (
    <div
      className="absolute content-stretch flex h-[14px] items-start left-[137px] top-[30.7px] w-[116px]"
      data-name="Text"
    >
      <p className="font-['Press_Start_2P:Regular',sans-serif] leading-[25.2px] not-italic relative shrink-0 text-[14px] text-black text-center text-nowrap tracking-[0.5px] whitespace-pre">
        Trainer!
...
function PokemonFrame() {
  return (
    <div
      className="absolute bg-white h-[108.391px] left-[19px] top-[159px] w-[448px]"
...
function Paragraph() {
  return (
    <div className="h-[15px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Press_Start_2P:Regular',sans-serif] leading-[15px] left-[210px] not-italic text-[#8b9594] text-[12px] text-center text-nowrap top-[1.5px] translate-x-[-50%] whitespace-pre">
        FINAL SCORE
      </p>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[36px] items-center justify-center p-[2px] relative w-[64px]">
        <p className="font-['Press_Start_2P:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[12px] text-nowrap text-white whitespace-pre">
          7
        </p>
      </div>
    </div>
...
function Container14() {
  return (
    <div
      className="h-[36px] opacity-20 relative shrink-0 w-[30px]"
      data-name="Container"
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[36px] relative w-[30px]">
        <p className="absolute font-['Press_Start_2P:Regular',sans-serif] leading-[36px] left-0 not-italic text-[30px] text-neutral-950 text-nowrap top-0 whitespace-pre">
...
function Container16() {
  return (
    <div
      className="absolute bg-white box-border content-stretch flex flex-col gap-[12px] h-[231px] items-start left-[19px] pb-[2px] pt-[14px] px-[14px] top-[283.39px] w-[448px]"
      data-name="Container"
    >
      <div
        aria-hidden="true"
...
function Button() {
  return (
    <div
      className="absolute bg-black h-[70px] left-[19px] top-[530.39px] w-[448px]"
      data-name="Button"
    >
      <div
        aria-hidden="true"
...
function Container17() {
  return (
    <div
      className="bg-white h-[619.391px] relative shrink-0 w-full"
      data-name="Container"
    >
      <div
        aria-hidden="true"
...
function Container18() {
  return (
    <div
      className="bg-[#d4dedd] h-[701.391px] relative shrink-0 w-full"
      data-name="Container"
    >
      <div
        aria-hidden="true"
...
function Container19() {
  return (
    <div
      className="bg-[#b4bfbe] h-[713.391px] relative shrink-0 w-[512px]"
      data-name="Container"
    >
